...
public class TabFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mLineChart = (LineChart) view.findViewById(R.id.linechart_2);
    ...
    public class getHistoricalData extends AsyncTask<Object, Object, ArrayList<String>> {
        ...
        protected ArrayList<String> doInBackground(Object... params) {
            ...
            String oneMonthURL = Utils.getOneMonth(s);

            try {

                String getResponse = fetchData(oneMonthURL);
        ...
        protected void onPostExecute(ArrayList<String> strings) {
            ...
            if (isConnected) {
                ...
                Log.d(LOG_TAG, dateList.toString());
